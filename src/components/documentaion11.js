                ...
                <div>
                 ...
                 <div>
                     <div>
                         ...
                         <h1 className="intro">Create Governance Request</h1>
                                  ...
                                  <div style={{ display:'flex',alignItems:'center',height:'150px',justifyContent:'space-between', padding:'3px 25px'}}>
                                       <div><img src="galas.svg " alt=" "  className="galasImg"/></div> 
                                        <div>
                                            ...
                                            <div style={{fontWeight:'700'}}>Distribute Interest<br/>To Egr Holders</div>
                                        </div>
                                  </div>
                              </div>
                               <div className ="card1"> 
...
export default Documentation11;
