                ...
                <div>
                 ...
                 <div>
                     <div>
                         ...
                         <h1 className="intro">Interest Rate Governance</h1>
                                  ...
                                  <div style={{ display:'flex',alignItems:'center',height:'150px',justifyContent:'space-between', padding:'3px 25px'}}>
                                       <div><img src="galas.svg " alt=" "  className="galasImg"/></div> 
                                        <div>
                                            ...
                                            <div style={{fontWeight:'700'}}>Loan Approval<br/>Governance</div>
                                        </div>
                                  </div>
                              </div>
                               <div className ="card1"> 
                                   <div style={{ display:'flex',alignItems:'center',height:'150px',justifyContent:'space-between', padding:'3px 25px',}} >
                                       <div>
                                           ...
                                           <div style={{fontWeight:'700'}}> Interest Sharing</div>
                                           <div style={{fontWeight:'700'}}> Formula</div>
                                       </div>
