            ...
            <div className ="gala">
                ...
                <div>
                    <div>
                        ...
                        <div >
                            <ul className=" rent" data-aos="fade-right">
                                <li><a href="/loan-application " > Loan Application</a></li>
                                 ...
                                 <li id = "cup1"><a href="/reward-voters " > Reward Voters</a></li>
                        ...
                        <div>
                            <ul className="rent" data-aos="fade-right">
                                <li><a href="/how-egoras-treasury-work">How Egoras Treasury Work </a></li>
                 ...
                 <div>
                     <div>
                         ...
                         <h1 className="intro">Distribute Interest To Egr Holders</h1>
                                  ...
                                  <div style={{ display:'flex',alignItems:'center',height:'150px',justifyContent:'space-between', padding:'3px 25px'}}>
                                       <div><img src="galas.svg " alt=" "  className="galasImg"/></div> 
                                        <div>
                                            ...
                                            <div style={{fontWeight:'700'}}>Reward Voter</div>
                                        </div>
                                  </div>
                              </div>
                               <div className ="card1"> 
                                   <div style={{ display:'flex',alignItems:'center',height:'150px',justifyContent:'space-between', padding:'3px 25px',}} >
                                       <div>
                                           ...
                                           <div style={{fontWeight:'700'}}>Create Governance</div>
...
export default Documentation10;
