                ...
                <div>
                 ...
                 <div>
                     <div>
                         ...
                         <h1 className="intro">Validate Governance Request</h1>
                                  ...
                                  <div style={{ display:'flex',alignItems:'center',height:'150px',justifyContent:'space-between', padding:'3px 25px'}}>
                                       <div><img src="galas.svg " alt=" "  className="galasImg"/></div> 
                                        <div>
                                            ...
                                            <div style={{fontWeight:'700'}}>Governance Vote</div>
                                        </div>
                                  </div>
                              </div>
                               <div className ="card1"> 
                                   <div style={{ display:'flex',alignItems:'center',height:'150px',justifyContent:'space-between', padding:'3px 25px',}} >
                                       <div>
                                           ...
                                           <div style={{fontWeight:'700'}}>How Egoras Treasury </div>
                                           <div style={{fontWeight:'700'}}> Works</div>
                                       </div>
...
export default Documentation13;
