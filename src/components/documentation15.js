            ...
            <div className ="gala">
                ...
                <div>
                    <div>
                        ...
                        <div>
                            <ul className="rent" data-aos="fade-right">
                                <li><a href="/how-egoras-tresury-work">How Egoras Treasury Work </a></li>
                 ...
                 <div>
                     <div>
                         ...
                         <h1 className="intro">How Egoras Tresury Work</h1>
                                  ...
                                  <div style={{ display:'flex',alignItems:'center',height:'150px',justifyContent:'space-between', padding:'3px 25px'}}>
                                       <div><img src="galas.svg " alt=" "  className="galasImg"/></div> 
                                        <div>
                                            ...
                                            <div style={{fontWeight:'700'}}>Validate Governance<br/>Request</div>
                                        </div>
                                  </div>
                              </div>
                               <div className ="card1"> 
                                   <div style={{ display:'flex',alignItems:'center',height:'150px',justifyContent:'space-between', padding:'3px 25px',}} >
                                       <div>
                                           ...
                                           <div style={{fontWeight:'700'}}>Block Reward  </div>
                                            {/* <div style={{fontWeight:'700'}}>Dollar EUSD</div> */}
...
export default Documentation15;
