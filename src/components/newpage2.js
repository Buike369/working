            ...
            <div className ="gala">
                <div>
                    <div>
                        <div>
                            <form>
                                <input type="search" placeholder=" search" style={{paddingTop:'14px',paddingBottom:'14px',borderRadius:'8px',width:'60%',border: '1px solid #55BC7E',paddingLeft:'10px', marginBottom:'3em'}}/>
                            </form>
                        </div>
                        <div style={{border: '1px solid #DADADA',width:'60%',marginBottom:'4em'}}> </div>
                        <div style={{fontWeight:'bold',marginBottom:'3em'}}>Introduction</div>
                        <div style={{color:' #E4A788',fontSize:'0.8em',marginBottom:'3em'}}>GETTING STARTED</div>
                        <div>
                            <ul className=" rent" data-aos="fade-right">
                                <li><a href =" " style={{padding:'8px 13px 8px 13px',backgroundColor:' #EEF8F2',color:'#55BC7E',borderRadius:'6px' ,fontWeight:'bold'}}> What problem is Egoras trying to Solve</a></li>
                                <li><a href =" "> Egoras Decentralized Autonomous Organisation</a></li>
                                <li><a href =" "> Lending Partner Governance</a></li>
                                <li><a href =" ">Loan Approval Governance</a></li>
                                <li><a href =" "> Interest Rate Governance</a></li>
                                <li><a href =" "> Interest sharing formula</a></li>
                            </ul>
                        </div>
                        <div style={{color:' #E4A788',fontSize:'0.8em',marginBottom:'3em',marginTop:'2.5em'}}>UNCOLLATERALIZED LENDING MODULE</div>
                        <div>
                            <ul className=" rent" data-aos="fade-right">
                        ...
                        <div style={{color:' #E4A788',fontSize:'0.8em',marginBottom:'3em',marginTop:'2.5em'}} >EGORAS TOKEN ECONOMY</div>
                        <div>
                           <ul className=" rent" data-aos="fade-right">
                         ...
                         <div>
                          ...
                          <div style={{display:'flex',marginTop:'3em'}}>
                              <div className ="card1" data-aos="flip-left" data-aos-duration="3000">
                               ...
                               <div className ="card1" data-aos="flip-right" data-aos-duration="3000" style={{borderTop:'2px solid #04aa6d'}}>
                                   <div style={{ display:'flex',alignItems:'center',height:'150px',justifyContent:'space-between', padding:'3px 25px',}} >
                                       <div>
